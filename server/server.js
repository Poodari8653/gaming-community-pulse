...
const GAMES = Array.from(new Set([...YT_GAMES, ...DISCORD_GAMES]));
...
app.get("/api/analysis", async (req, res) => {
  try {
    ...
    const [ytResult, discordResult] = await Promise.all([
    ...
    const allRows = [...synthetic, ...ytResult.rows, ...discordResult.rows];
    ...
    const payload = {
      ...
      fetch_errors: [...ytResult.errors, ...discordResult.errors],
    };
